...
from pipelines.meteorologia.radar.guaratiba.constants import (
    constants as radar_constants,  # pylint: disable=E0611, E0401
)

# from pipelines.tasks import task_get_redis_client
from pipelines.meteorologia.radar.guaratiba.schedules import (  # pylint: disable=E0611, E0401
    TIME_SCHEDULE,
)
from pipelines.meteorologia.radar.guaratiba.tasks import (  # pylint: disable=E0611, E0401; combine_radar_files,
    access_api,
    add_new_image,
    base64_to_bytes,
    compress_to_zip,
...
with Flow(
    name="COR: Meteorologia - Mapa de Refletividade Radar de Guaratiba",
    ...
    table_id_previsao_chuva = Parameter(
        "table_id_previsao_chuva", default="preprocessamento_radar_guaratiba", required=False
    )

    # Dataset parameters
    station_type = Parameter("station_type", default="radar", required=False)
    source = Parameter("source", default="guaratiba", required=False)
    ...
    with case(SAVE_IMAGE_WITHOUT_BACKGROUND, True):
        ...
        with case(SAVE_IMAGE_WITHOUT_COLORBAR, True):
            ...
            (
                ...
                "cor-clima-imagens/radar/guaratiba/refletividade_horizontal/without_background/without_colorbar",
                filename_time,
    ...
    with case(SAVE_IMAGE_WITH_BACKGROUND, True):
        ...
        (
            ...
            "cor-clima-imagens/radar/guaratiba/refletividade_horizontal/with_background/with_colorbar",
            filename_time,
