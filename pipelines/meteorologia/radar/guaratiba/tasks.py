...
from pipelines.meteorologia.radar.guaratiba.utils import (  # pylint: disable=E0611, E0401
    create_colormap,
    extract_timestamp,
    open_radar_file,
    save_image_to_local,
...
def create_visualization(
    ...
    The Guaratiba radar is bringing images with values below 15 dBZ as green.
    Guaratiba detects from 2 dBZ, but most of time this value represents a cloud,
...
def access_api():
    ...
    base_url = get_secret(infisical_url, path="/api_radar_guaratiba")[infisical_url]
    username = get_secret(infisical_username, path="/api_radar_guaratiba")[infisical_username]
    password = get_secret(infisical_password, path="/api_radar_guaratiba")[infisical_password]
